...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectContext: NSManagedObjectContext = {
        ...
        var managedObjectContext = NSManagedObjectContext(concurrencyType: .privateQueueConcurrencyType) //http://stackoverflow.com/questions/25812268/core-data-error-exception-was-caught-during-core-data-change-processing
