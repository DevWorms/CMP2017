        ...
        <div class="container-fluid">
            ...
            <div class="row page-header">
                ...
                <div class="col-xs-12 col-md-6" align="right">
                    <a href="agregar-transportacion.php" class="btn basico" id="btn_crearEvento"><i
                                class="fa fa-plus-circle"></i> &nbsp;Agregar Ruta</a>
                </div>
            </div>
            <!-- Fin Fila -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center;">Evento: ${titulo}</h4>
                </div>
