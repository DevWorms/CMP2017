            ...
            <div class="container-fluid">
                ...
                <div class="row page-header">
                    ...
                    <div class="col-xs-12 col-md-6" align="right">
                        <a href="syd-add-evento.php" class="btn basico"><i class="fa fa-plus-circle"></i> &nbsp;Agregar Evento</a>   
                    </div>
                </div>
                <!-- Fin Fila -->
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <table class="table table-striped" id="tbl_syd">
                            <thead>
                              <tr>
