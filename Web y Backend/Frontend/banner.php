        ...
        <div class="container-fluid">
            ...
            <div class="row page-header">
                ...
                <div class="col-xs-12 col-md-6" align="right">
                    <a href="agregar-banner.php" class="btn basico" id="btn_crearEvento"><i
                                class="fa fa-plus-circle"></i> &nbsp;Agregar Banner</a>
                </div>
            </div>
            <!-- Fin Fila -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center;">Banner: ${nombre}</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <p><strong>Nombre</strong>: <a href="${url}" target="_blank">${nombre}</a></p>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
                </div>
